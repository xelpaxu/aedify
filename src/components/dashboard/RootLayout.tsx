...
export function RootLayout({ children }: RootLayoutProps) {
  ...
  return (
    <div className="flex relative h-screen w-full overflow-hidden bg-[#f8fafc] text-slate-800 font-sans">
      <Sidebar />
      ...
      <main className="flex-1 flex flex-col relative overflow-hidden bg-[#f8fafc]">
        ...
        <section className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 scroll-smooth">
