...
export default defineSchema({
  ...
  reports: defineTable({
    ...
    reviewType: v.optional(v.literal("admin-modified")),
    adminNotes: v.optional(v.string()),
    analysisIssue: v.optional(v.union(
    ...
    correctedClassification: v.optional(v.string()),
    correctedFindings: v.optional(v.string()),
