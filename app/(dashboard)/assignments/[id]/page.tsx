...
export default function AssignmentDetailPage() {
  ...
  // Images
  const imageUrl = getReportPreview(reportObj) || getReportPreview(assignment) || '/assets/images/breeding-site.jpeg'
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in-up pb-12">
      ...
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-3xl bg-white text-slate-900 border border-slate-200 shadow-sm dark:bg-slate-950 dark:text-white dark:border-slate-800">
        <div className="relative z-10 p-7 pb-6">
          <div className="flex items-center gap-2 mb-4">
            <Link
              href="/assignments"
              className="p-1.5 hover:bg-slate-100 dark:hover:bg-white/10 rounded-xl transition-colors text-slate-500 dark:text-white/60 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-white/10"
            >
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-slate-600 dark:text-white/70">
                <span className="flex items-center gap-1.5 text-slate-700 dark:text-white font-medium">
            ...
            <div className="flex items-center gap-2">
              ...
              {isPendingReport && (
                <span className="flex items-center gap-2 px-4 py-2 bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-400/30 rounded-xl text-xs font-bold">
        ...
        {/* Bottom bar */}
        <div className="relative z-10 px-7 py-3.5 bg-slate-50 dark:bg-white/5 border-t border-slate-200 dark:border-white/10 flex flex-wrap items-center gap-6 text-xs">
          {isAssignment ? (
            <>
              <div className="flex items-center gap-2">
                <Users className="h-4 w-4 text-primary-700 dark:text-primary-400" />
                <span className="text-slate-500 dark:text-white/60">Field Unit:</span>
                <span className="font-bold text-slate-900 dark:text-white">{assignment.memberIds?.length || 2} Officers</span>
              </div>
              <div className="w-px h-4 bg-slate-200 dark:bg-white/10" />
              <div className="flex items-center gap-2">
                <Shield className="h-4 w-4 text-amber-400" />
                <span className="text-slate-500 dark:text-white/60">Leader:</span>
                <span className="font-semibold text-slate-800 dark:text-white/90">{leaderName}</span>
              </div>
            </>
          ) : (
            <div className="flex items-center gap-2">
              <User className="h-4 w-4 text-primary-700 dark:text-primary-400" />
              <span className="text-slate-500 dark:text-white/60">Reporting Tanod:</span>
              <span className="font-bold text-slate-900 dark:text-white">{reportObj.userName || 'Tanod Patrol Officer'}</span>
            </div>
          )}
          <div className="w-px h-4 bg-slate-200 dark:bg-white/10" />
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-amber-700 dark:text-amber-300">{confidenceScore}%</span>
          </div>
          <div className="w-px h-4 bg-slate-200 dark:bg-white/10" />
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-900 dark:text-white uppercase text-[11px]">{statusLabel}</span>
          </div>
        </div>
      </div>
